...
urlpatterns = [
    ...
    path(
        "api/projects/<int:project_id>/contributors/add/",
        AddContributorView.as_view(),
        name="add-contributor",
    ),
    path(
        "api/projects/<int:project_id>/contributors/remove/<int:user_id>/",
        RemoveContributorView.as_view(),
        name="remove-contributor",
    ),
    path(
        "api/issues/<uuid:issue_id>/assign/",
        AssignIssueView.as_view(),
        name="assign_issue",
    ),
    path(
        "api/issues/<uuid:issue_id>/status/",
        UpdateIssueStatusView.as_view(),
        name="update-issue-status",
    ),
    path(
        "api/comments/<uuid:pk>/",
